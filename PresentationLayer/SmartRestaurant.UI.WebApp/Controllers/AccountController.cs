...
namespace SmartRestaurant.UI.WebApp.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RestaurantModel model)
        {
            if (ModelState.IsValid)
            {
                var result = new AppUser(model);
                if (result.Succeeded)
                {
                    TempData["validationmsg"] = "Register Sucessfully....";
